    ...
    <div className="scroll-mt-24 space-y-3" data-testid="money-hero" id="net-worth">
      ...
      {composition ? (
        ...
        >
          ...
          {hasChart ? null : (
            <p
              className="mt-3 border-t border-stone-100 pt-3 text-[11px] text-earth-500"
...
function HeroTileCard({
  ...
  const body = (
    <>
      ...
      {tile.caption ? (
        <p className="mt-1.5 text-[11px] text-earth-500">{tile.caption}</p>
      ) : null}
      {tile.band ? (
        <div className="mt-3">
          ...
          <div className="mt-1 flex justify-between text-[11px] font-medium text-earth-600">
