  ...
  return {
    ...
    connectionNotice: {
      ...
      message:
        ...
        `No user data was saved. ${errorMessage(error)}`,
    },
  };
}
...
function buildSummaryMetrics(
  ...
  const monthlySurplus = decimal(report.cash_flow.monthly_surplus_after_investing);
...
function mapProvenance(value: string): Provenance {
  ...
  return provenanceMap[value] ?? "calculated";
}
